# joola.io Template Store [![Build Status][3]][4] [![Gitter chat](https://badges.gitter.im/joola/joola.io.png)](https://gitter.im/joola/joola.io)
...
<img src="https://joo.la/img/logo-profile.png" alt="joola.io logo" title="joola.io" align="right" />

[joola.io][22] is a real-time data analytics and visualization framework.
**joola.io.datastore-template** is a joola.io plugin to provide template based data store for its operation.
...
[1]: https://coveralls.io/repos/joola/joola.io.datastore-template/badge.png?branch=develop
[2]: https://coveralls.io/r/joola/joola.io.datastore-template?branch=develop
[3]: https://travis-ci.org/joola/joola.io.datastore-template.png?branch=develop
[4]: https://travis-ci.org/joola/joola.io.datastore-template?branch=develop
